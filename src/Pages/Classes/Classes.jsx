...
const Classes = () => {
    ...
    const approvedClasses = classesInfo.filter((item) => item.status !== "pending"  && item.status !== "denied" )
    ...
    const handleSelectClass = (classes) => {
        ...
        if (user && user.email) {
            ...
            fetch('https://summer-camp-scl-server-tisha-akter.vercel.app/selectedClasses', {
                method: 'POST',
                headers: {
